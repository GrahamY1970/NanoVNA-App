...
#define WM_UPDATE_S21_OFFSET			(WM_USER + 118)
#define WM_COM_DEVICE_CHANGED			(WM_USER + 119)
#define WM_REBUILD_FONTS				(WM_USER + 120)
...
// graph types
enum {
  GRAPH_TYPE_LOGMAG_S11 = 0,
  GRAPH_TYPE_LOGMAG_S21,
  GRAPH_TYPE_LOGMAG_S11S21,
  GRAPH_TYPE_LINMAG_S11,
  GRAPH_TYPE_LINMAG_S21,
  GRAPH_TYPE_LINMAG_S11S21,
  GRAPH_TYPE_PHASE_S11,
  GRAPH_TYPE_PHASE_S21,
  GRAPH_TYPE_PHASE_S11S21,
  GRAPH_TYPE_PHASE_UNWRAP_S11,
  GRAPH_TYPE_PHASE_UNWRAP_S21,
  GRAPH_TYPE_PHASE_UNWRAP_S11S21,
  GRAPH_TYPE_VSWR_S11,
  GRAPH_TYPE_IMPEDANCE_S11,
  GRAPH_TYPE_SERIES_RJX_S11,
  GRAPH_TYPE_PARALLEL_RJX_S11,
  GRAPH_TYPE_QUALITY_FACTOR_S11,
  GRAPH_TYPE_SMITH_S11,
  GRAPH_TYPE_SMITH_S21,
  GRAPH_TYPE_ADMITTANCE_S11,
  GRAPH_TYPE_ADMITTANCE_S21,
  GRAPH_TYPE_POLAR_S11,
  GRAPH_TYPE_POLAR_S21,
  GRAPH_TYPE_GROUP_DELAY_S11,
  GRAPH_TYPE_GROUP_DELAY_S21,
  GRAPH_TYPE_GROUP_DELAY_S11S21,
  GRAPH_TYPE_TDR_LIN_LP_IMPULSE_S11,
  GRAPH_TYPE_TDR_LIN_BP_S11,
  GRAPH_TYPE_TDR_LOG_LP_IMPULSE_S11,
  GRAPH_TYPE_TDR_LOG_BP_S11,
  GRAPH_TYPE_TDR_IMPEDANCE_S11,
  GRAPH_TYPE_REAL_IMAG_S11,
  GRAPH_TYPE_REAL_IMAG_S21,
  GRAPH_TYPE_SERIES_CAPACITANCE_S11,
  GRAPH_TYPE_SERIES_INDUCTANCE_S11,
  GRAPH_TYPE_SERIES_RESISTANCE_S11,
  GRAPH_TYPE_SERIES_REACTANCE_S11,
  GRAPH_TYPE_COAX_LOSS_S11,
  GRAPH_TYPE_CAL_LOGMAG,
  GRAPH_TYPE_PHASE_VECTOR_S11,
  GRAPH_TYPE_PHASE_VECTOR_S21,
  GRAPH_TYPE_SIZE       // set this one to the number of graph types their are
};
// **************
...
enum t_serial_state : int
{
	...
	SERIAL_STATE_SD_READ,
	SERIAL_STATE_SD_DELETE,
	SERIAL_STATE_MODE
};
